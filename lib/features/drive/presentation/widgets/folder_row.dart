...
class FolderRow extends ConsumerWidget {
          ...
          child: Row(
            ...
            children: [
              ...
              TextButton.icon(
                ...
                label: const Text('New', style: TextStyle(color: AppTheme.primary, fontSize: 13)),
              ),
            ],
          ),
        ),
            ...
            if (folders.isEmpty) {
              return Padding(
                ...
                child: Container(
                  ...
                  child: const Row(
                    children: [
                      Icon(Icons.folder_open_rounded, color: AppTheme.textSecondary, size: 20),
                      SizedBox(width: 12),
            ...
            return SizedBox(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, i) {
                  ...
                  final color = Color(
                    int.parse((folder.colorHex ?? '#4F6FFF').replaceFirst('#', '0xFF')),
                  );
  ...
  void _showCreateFolderDialog(BuildContext context, WidgetRef ref) {
    ...
    final colors = ['#4F6FFF', '#00C48C', '#FFB800', '#FF4D4D', '#7C3AED', '#DB2777'];
    ...
    showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setState) => AlertDialog(
          ...
          title: const Text('New Folder', style: TextStyle(color: AppTheme.textPrimary, fontWeight: FontWeight.w700)),
          content: Column(
            ...
            children: [
              TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.folder_rounded, color: AppTheme.textSecondary),
                ),
              ),
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: const Text('Delete Folder', style: TextStyle(color: AppTheme.error)),
              onTap: () {
