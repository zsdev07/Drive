  ...
  Widget _buildQrSection() {
    ...
    return AnimatedBuilder(
      ...
      child: Container(
        ...
        child: _QrWidget(data: _token!.link),
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Row(
            children: [
              Icon(Icons.link_rounded, color: AppTheme.textSecondary, size: 13),
              SizedBox(width: 6),
...
// ─────────────────────────────────────────────────────────────────────────────
// _QrWidget — renders the tg:// URI as a QR code (pure-Dart painter).
// ─────────────────────────────────────────────────────────────────────────────
